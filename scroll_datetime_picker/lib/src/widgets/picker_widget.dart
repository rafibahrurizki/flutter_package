...
class PickerWidget extends StatefulWidget {
  const PickerWidget({
    required this.itemCount, required this.itemExtent, required this.infiniteScroll, required this.onChange, required this.controller, required this.activeBuilder, required this.inactiveBuilder, required this.wheelOption, super.key,
  });
